...
// Anycubic Probe version 1 or 2 see README.md; 0 for no probe WLOO
#define ANYCUBIC_PROBE_VERSION 2

// Heated Bed:
// 0 ... no heated bed
// 1 ... aluminium heated bed with "BuildTak-like" sticker WLOO
 ...
 * WLOO from 0 to 3 for my ESP-12S wifi module - do not reverse this port with serial_port_2 as it wont work
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7] WLOO enabled two lines and for USB connection
 */
...
// Name displayed in the LCD "Ready" message and Info menu WLOO
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    // set the default number of probe points : n*n (1 -> 7) WLOO from 4 to 6
  ...
  // Distance between bed and nozzle Z home position WLOO 320 to 291.27
  #define DELTA_HEIGHT 291.27             // (mm) Get this value from G33 auto calibrate
 ...
 *          TMC5130, TMC5130_STANDALONE, TMC5160, TMC5160_STANDALONE WLOO
 ...
 * Override with M204
 * WLOO - 3000,3000,3000  to 2000, 3000, 2000 for a start
 *   M204 P    Acceleration
 ...
 * (Automatically enables USE_PROBE_FOR_Z_HOMING.) WLOO - enable Probe at PE4
 */
#if ANYCUBIC_PROBE_VERSION > 0
 ...
 *     O-- FRONT --+
 */
#if ANYCUBIC_PROBE_VERSION == 2 //default is -16.80 ACTUAL is -16.73 WLOO
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way. WLOO
...
// For direct drive extruder v9 set to true, for geared extruder set to false. WLOO
 ...
 *   With an LCD controller the process is guided step-by-step.  WLOO
 */
#if ANYCUBIC_PROBE_VERSION == 0
 ...
 * leveling immediately after G28. WLOO
 */
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // The height can be set with M420 Z<height> WLOO
  ...
  /**
   * Enable the G26 Mesh Validation Pattern tool. WLOO
   */
  ...
  //#define PROBE_Y_FIRST
    ...
    // Synthesizes intermediate points to produce a more detailed mesh. WLOO - enabled subdivision
    //
    #define ABL_BILINEAR_SUBDIVISION
    #if ENABLED(ABL_BILINEAR_SUBDIVISION)
      // Number of subdivisions between probe points WLOO - from 3 to 5
  ...
  #define MESH_INSET 10              // Set Mesh bounds as an inset region of the bed WLOO from 1 to 10
 ...
 * - If stepper drivers sleep, XY homing may be required again before Z homing. WLOO
 */
...
// Delta only homes to Z - WLOO From 100*60 to 50*60, (60*60 is still fast) to get 3000mm/min
...
// WLOO Adjust for ABS - 240 to 230
