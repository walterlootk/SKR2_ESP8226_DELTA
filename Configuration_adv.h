 ...
 * the fan will turn on when any selected extruder is above the threshold. WLOO-FAN1_PIN for extruder fan
 */
 ...
 */
   ...
   * WLOO - changed for AXIS_IS_TMC(E0) from 800 to 950
   */
